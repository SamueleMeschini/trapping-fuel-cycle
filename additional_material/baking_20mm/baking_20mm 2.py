...
for T, solution in zip(temperatures, solutions):
    ...
    ax.plot(structured_array['t(s)'], structured_array['Total retention volume 1']/(e/2)/(n_mobile+n_trapped), label=f"{T} K", color=cm.Reds(norm(T)))
...
plt.savefig('retained_fraction_20mm.png', dpi=300)
